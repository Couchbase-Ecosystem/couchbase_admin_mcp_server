...
1. with `163.116.250.45/32` alone listed,
2. with `163.116.250.146/32` also listed, after the portquiz probe named it,
3. **with the whole of `163.116.250.0/24` listed.**
...
This also makes an earlier open question moot. Whether `163.116.250.45` was a VPN
...
|---|---|---|---|---|
| `163.116.250.45/32` | active | 2026-08-17T16:10:59 | Chris's user | (none) |
| `76.202.119.118/32` | active | 2026-09-12T17:11:35 | the API key | real egress to us-east-1 |
...
2. **"`163.116.250.45/32` is still the only `/32` on the cluster."** A reading
...
$U = 'https://cloudapi.cloud.couchbase.com/v4/organizations/42730eb3-53ab-451a-b5eb-8eeb9a92084c/projects/be388b87-43cb-4e9b-a3f1-0f837609c4af/clusters/85298b32-c01f-417d-8485-44ceb543af4f/allowedcidrs'
